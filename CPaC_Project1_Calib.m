...
% im1 = imread('./Structured Light Data/calibration/0000.png'); 
% im1 = imresize(im1,0.5);
% im1 = im2double(im1);
% 
% im2 = imread('./Structured Light Data/calibration/0002.png'); 
% im2 = imresize(im2,0.5);
% im2 = im2double(im2);
% 
% im3 = imread('./Structured Light Data/calibration/0004.png'); 
...
H_p1_c = load('H_p1_c.mat');
H_p1_c = H_p1_c.H_p1_c;
H_p2_c = load('H_p2_c.mat');
H_p2_c = H_p2_c.H_p2_c;
H_p3_c = load('H_p3_c.mat');
...
% P-p-projected: 1024*768
% Order: Top-Left, Top-Right, Bot-Right, Bot-Left
P2 = [378,648,648,378;277,277,547,547];
