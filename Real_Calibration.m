...
% im1 = imread('./real1.JPG'); 
% im1 = imresize(im1,0.5);
% im1 = im2double(im1);
% 
% im2 = imread('./real2.JPG'); 
% im2 = imresize(im2,0.5);
% im2 = im2double(im2);
% 
% im3 = imread('./real3.JPG'); 
...
H_p1_c = load('real_H_p1_c.mat');
H_p1_c = H_p1_c.H_p1_c;
H_p2_c = load('real_H_p2_c.mat');
H_p2_c = H_p2_c.H_p2_c;
H_p3_c = load('real_H_p3_c.mat');
...
P2 = [568,768,768,568;170,170,370,370];
